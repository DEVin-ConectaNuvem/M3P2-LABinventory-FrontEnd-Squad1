...
describe('Verifica se é possível emprestar um item', () => {
  ...
  it('Os dados são exibidos corretamente na tela', () => {
    ...
    cy.get(`[data-testid='item-${item.id}-title']`).should('include.text', item.title)

    cy.get(`[data-testid='item-${item.id}-status']`).should('include.text', 'Item disponível')
    ...
    cy.get(`[data-testid='item-${item.id}-borrow-or-return-button']`).should('include.text', 'Emprestar item')

    cy.get(`[data-testid='item-${item.id}-edit-button']`).should('include.text', 'Editar item')
  })
  ...
  it('Empresta um item com sucesso', () => {
    ...
    cy.get(`[data-testid='item-${item.id}']`).should('include.text', item.title).click()

    cy.get(`[data-testid='item-${item.id}-borrow-or-return-button']`).should('include.text', 'Emprestar item').click()
...
describe('Verifica se é possível devolver um item', () => {
  ...
  it('Devolve um item com sucesso', () => {
    ...
    cy.get(`[data-testid='item-${item.id}-borrow-or-return-button']`).should('include.text', 'Devolver Item').click()
