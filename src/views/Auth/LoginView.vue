            ...
            <div class="row g-0">
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <VeeForm @submit="onValidSubmit" v-slot="{ errors }" @invalid-submit="onInvalidSubmit" class="animate__animated animate__backInLeft">
                    ...
                    <div class="text-center ">
                      <button :class="register.register ? 'btn btn-success mb-3' : 'btn btn-info text-dark mb-3'" type="submit"
                    ...
                    <div class="d-flex align-items-end justify-content-center ">
                      <p class="mb-0 me-2 text-bg-light badge " v-text="register.haveAccount"></p>
              ...
              <div class="col-lg-6 d-flex align-items-center">
                <img src="../../assets/icons/Workspace_2_SVG.svg" class="imgback img-fluid animate__animated animate__backInRight" alt="">
              </div>
            </div>
          </div>
        </div>
