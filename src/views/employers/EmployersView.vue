            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    ...
                    <Veefield type="text" name="zipcode" class="form-control" placeholder="CEP" v-model="form.zipcode"
                        @focusout="searchZipCode" required v-mask="'#####-###'"
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    ...
                    <Veefield type="number" name="houseNumber" class="form-control" placeholder="Número da residência"
                        :rules="validateNumber" v-model="form.houseNumber" required
...
import { validateEmail, validateName, required, validateDate, validatePhone, validateNumber } from '../../validators/validators'
...
function onValidSubmit(values, actions) {
    ...
    actions.resetForm();
    loader.hide()
    toast.success('Cadastro de colaborador realizado com sucesso!', { timeout: 1500,
    timeout: false,
    closeOnClick: false,
    pauseOnFocusLoss: false,
    pauseOnHover: false,
